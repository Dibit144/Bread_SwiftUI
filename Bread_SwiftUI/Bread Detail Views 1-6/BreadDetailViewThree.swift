...
struct BreadDetailViewThree: View {
    var body: some View {
        ScrollView {
            VStack {
                Image("bread_three")
                ...
                Text("Two sour dough fresh from the oven")
            ...
            .navigationBarTitle("Two Sour Dough")
        }
    }
}

struct BreadDetailViewThree_Previews: PreviewProvider {
    static var previews: some View {
        BreadDetailViewThree()
    }
}
